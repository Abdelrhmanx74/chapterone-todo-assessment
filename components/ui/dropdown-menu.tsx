            ...
            <TextClassContext.Provider value="text-popover-foreground">
              <DropdownMenuPrimitive.Content
                className={cn(
                  ...
                  Platform.select({
                    web: cn(
                      'z-50 max-h-[var(--radix-context-menu-content-available-height)] origin-[var(--radix-context-menu-content-transform-origin)] cursor-default animate-in fade-in-0 zoom-in-95',
